...
namespace Optimization.Tests
{
    ...
    public class WalkForwardSharpeMaximizerTests
    {
        ...
        //todo:
        //[TestCase("2001-01-01", "2001-01-03", 2, new[] { "2001-01-01 00:00:00", "2001-01-02 00:00:00" },
        //    new[] { "2001-01-02 23:59:59", "2001-01-03 23:59:59" })]
        //[TestCase("2001-01-01", "2002-07-02", 2, new[] { "2001-01-01 00:00:00", "2001-07-02 12:00:00" }, 
        //    new[] { "2001-12-31 23:59:59", "2002-07-02 23:59:59" })]
        //[TestCase("2001-01-01", "2001-01-04", 3, new[] { "2001-01-01 00:00:00", "2001-01-02 00:00:00", "2001-01-03 00:00:00" },
        //    new[] { "2001-01-02 23:59:59", "2001-01-03 23:59:59", "2001-01-04 23:59:59" })]
        //[TestCase("2001-01-01", "2001-01-05", 4, new[] { "2001-01-01 00:00:00", "2001-01-02 00:00:00", "2001-01-03 00:00:00", "2001-01-04 00:00:00" },
        //    new[] { "2001-01-02 23:59:59", "2001-01-03 23:59:59", "2001-01-04 23:59:59", "2001-01-05 23:59:59" })]
        public void GetScoreTest(DateTime startDate, DateTime endDate, int folds, string[] expectedStartDate, string[] expectedEndDate)
        {
            ...
            var unit = new Mock<WalkForwardSharpeMaximizer>(new OptimizerConfiguration
            {
                StartDate = startDate,
                EndDate = endDate,
